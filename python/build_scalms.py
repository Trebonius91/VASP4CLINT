#!/usr/bin/env python3
#
#    build_scalms: Build VASP POSCAR files with atoms positioned on 
#      a regular cubic grid, designed for simulation of SCALMS 
...
print('''
This script manages the buildup of unary/binary/ternary SCALMS
systems in a randomized manner, i.e., the number 
...
print("""
build_scalms.py has finished! A POSCAR file with your system was written!
""")
